...
//        }
        ...
        return $this->render('task/index.html.twig', [
            ...
            'unstartedTasks' => $taskRepository->findBy(['state' => 'unstarted']),
            'inProgressTasks' => $taskRepository->findBy(['state' => 'in_progress']),
            'completedTasks' => $taskRepository->findBy(['state' => 'completed']),
        ]);
    }
